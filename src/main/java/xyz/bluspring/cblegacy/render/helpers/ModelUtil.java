package xyz.bluspring.cblegacy.render.helpers;
...
import xyz.bluspring.cblegacy.core.ReflectionWrapper;
...
import xyz.bluspring.cblegacy.render.chiseledblock.ChiselLayer;
import xyz.bluspring.cblegacy.render.chiseledblock.ChiseledBlockBaked;
...
public class ModelUtil implements ICacheClearable
{
			...
			final BlockRenderLayer layer )
	{
		...
		final HashMap<EnumFacing, ArrayList<ModelQuadLayer.ModelQuadLayerBuilder>> tmp = new HashMap<EnumFacing, ArrayList<ModelQuadLayer.ModelQuadLayerBuilder>>();
	...
	private static void processFaces(
			final HashMap<EnumFacing, ArrayList<ModelQuadLayer.ModelQuadLayerBuilder>> tmp,
