...
import xyz.bluspring.cblegacy.api.EventBlockBitModification;
...
import xyz.bluspring.cblegacy.interfaces.IVoxelBlobItem;
...
import xyz.bluspring.cblegacy.render.helpers.SimpleInstanceCache;
						...
						for ( int z = 0; z < 2; z++ )
						{
							if ( blobs[x][y][z].filled() > 0 )
							{
								...
								if ( world.isAirBlock( bp ) )
								{
									...
									BlockChiseled.ReplaceWithChisledValue rv =  BlockChiseled.replaceWithChisled( world, bp, state, commonBlock, true );
