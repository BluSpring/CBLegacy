...
import xyz.bluspring.cblegacy.bittank.BlockBitTank;
...
public class ModBlocks extends ModRegistry
{
			...
			final EnvType side )
	{
		...
		Registry.register(Registry.BLOCK_ENTITY_TYPE, TE_CHISELEDBLOCK, );
		...
		{
			GameRegistry.registerTileEntity( TileEntityBlockChiseled.TileEntityBlockChiseledDummy.class, TE_CHISELEDBLOCK_TESR );
		}
